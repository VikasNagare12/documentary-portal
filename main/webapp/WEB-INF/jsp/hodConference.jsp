...
<head>
    ...
    <!-- style css -->
    <link rZxel="stylesheet" href="${pageContext.request.contextPath}/std/assets/css/typography.css">
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center table-hover">
                                        ...
                                        ArrayList conferenceDetails= ConferenceDoa.getAllConferenceDetailsH();
