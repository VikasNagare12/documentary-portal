...
<body>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Book Detail Table</h4>
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center table-hover">
                                        ...
                                        ArrayList bookDetails= BookDoa.getAllBookDetails(name);
                                         Bookbean book = null;
                                        ...
                                        %>
                                        <tr onclick="window.location='./book/getUpdate.vi?id=<%= book.getId()%>';"  style='cursor: pointer;'>
                                            	<td><%= book.getId() %></td>
                                            	<td><%= book.getTitle() %></td>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2018. All right reserved. Designed by BALAJI.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
